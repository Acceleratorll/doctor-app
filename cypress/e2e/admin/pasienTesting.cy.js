...
describe("pasien testing", () => {
    ...
    it("change password user", () => {
        cy.get(".odd > .project-actions > form > .btn-primary").click();
        cy.get(":nth-child(1) > .form-group > .form-control").type("12345");
        cy.get(":nth-child(2) > .form-group > .form-control").type("12345");
        cy.get(".btn").click();
        cy.contains("Password changed successfully").should("exist");
    });

    it("change password user not match", () => {
        cy.get(".odd > .project-actions > form > .btn-primary").click();
        cy.get(":nth-child(1) > .form-group > .form-control").type("12344");
        cy.get(":nth-child(2) > .form-group > .form-control").type("12345");
        cy.get(".btn").click();
