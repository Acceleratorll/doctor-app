            ...
            <div class="form-row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{ $employee->birth_date }}" placeholder="Masukkan Tanggal Lahir" class="form-control" value="<?php echo date('Y-m-d'); ?>" name="birth_date" id="tanggallahir" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
